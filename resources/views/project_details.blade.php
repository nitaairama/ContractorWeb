...
<title>Orbit - Project Details</title>
                                ...
                                <script type="application/json" class="swiper-config">
                  {
                      ...
                      "prevEl": ".swiper-button-prev"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="assets/img/portfolio/portfolio-5.webp" alt="Project Showcase"
                                            class="img-fluid">
                                    </div>
                                    <div class="swiper-slide">
                    ...
                    <div class="col-lg-5" data-aos="fade-left" data-aos-delay="200">
                        <div class="project-info-card">
                            ...
                            <p class="project-excerpt">Pellentesque habitant morbi tristique senectus et netus et
                    ...
                    <div class="row gy-5">
                        <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
                            <div class="content-block">
                                ...
                                <p class="lead-text">Curabitur aliquet quam id dui posuere blandit. Nulla porttitor
                                    accumsan tincidunt. Praesent sapien massa, convallis a pellentesque nec, egestas non
                                    nisi.</p>
                                <p>Sed porttitor lectus nibh. Cras ultricies ligula sed magna dictum porta. Vivamus
                                    suscipit tortor eget felis porttitor volutpat. Curabitur non nulla sit amet nisl
                                    tempus convallis quis ac lectus. Proin eget tortor risus. Curabitur aliquet quam id
                                    dui posuere blandit.</p>
                                <p>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vestibulum ac diam sit
                                    amet quam vehicula elementum sed sit amet dui. Curabitur arcu erat, accumsan id
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="cs-card solution">
                                            ...
                                            <h4>Our Solution</h4>
                                            <p>Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus.
                                                Cras ultricies ligula sed magna dictum porta mauris.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="gallery-card large">
                                <a href="assets/img/portfolio/portfolio-11.webp" class="glightbox">
                                    <img src="assets/img/portfolio/portfolio-11.webp" alt="Project Screenshot"
                                ...
                                <div class="col-12">
                                    <div class="gallery-card">
                                        <a href="assets/img/portfolio/portfolio-12.webp" class="glightbox">
                                            <img src="assets/img/portfolio/portfolio-12.webp" alt="Project Screenshot"
                                                class="img-fluid" loading="lazy">
                                            <div class="gallery-overlay">
                                                <i class="bi bi-zoom-in"></i>
                                            </div>
                                ...
                                <div class="col-6">
                                    <div class="gallery-card">
                                        <a href="assets/img/portfolio/portfolio-2.webp" class="glightbox">
                                            <img src="assets/img/portfolio/portfolio-2.webp" alt="Project Screenshot"
                                                class="img-fluid" loading="lazy">
                                            <div class="gallery-overlay">
                                                <i class="bi bi-zoom-in"></i>
                                            </div>
                                ...
                                <div class="col-6">
                                    <div class="gallery-card">
                                        <a href="assets/img/portfolio/portfolio-3.webp" class="glightbox">
                                            <img src="assets/img/portfolio/portfolio-3.webp" alt="Project Screenshot"
                                                class="img-fluid" loading="lazy">
                                            <div class="gallery-overlay">
                                                <i class="bi bi-zoom-in"></i>
                                            </div>
